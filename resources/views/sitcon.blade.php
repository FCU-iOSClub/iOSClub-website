...
<body>
  <div class="wrapper">
    ...
    <a href="{{route('home')}}" style="position: absolute;top:3%;left:3%;color:#551A8B">回首頁</a>
  </div>
  ...
  <div class="wrapper content1 ">
    ...
    <div class="panel panel_content2 zindex9999">
      <p class="p-m0 gift-content mt-2">當天將舉辦交換禮物，想參加的人可以帶等同 NT100 的禮物來交換哦，幹部們也提供一把 <span class="yellow">Ducky One2</span> 地平線，當作驚喜跟大家一起交換，不要錯過摟！！！</p>
    </div>
    <div class="gift">
      <div class="price"></div>
    </div>
