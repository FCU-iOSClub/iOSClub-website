...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="button register"> 報名 </div>
    ...
    <div class="wrapper content1 ">
        ...
        <div class="panel panel_content2 zindex9999">
            <p class="p-m0 gift-content">當天將舉辦交換禮物，</p>
            <p class="p-m0 gift-content">想參加的人可以帶價值 100 NT的禮物來交換哦，</p>
            <p class="p-m0 gift-content">幹部們也提供一把 Ducky One2 地平線，</p>
            <p class="p-m0 gift-content">當作驚喜跟大家一起交換，</p>
            <p class="p-m0 gift-content">不要錯過摟！！！</p>
        </div>
        <div class="gift">
            <div class="price"></div>
        </div>
